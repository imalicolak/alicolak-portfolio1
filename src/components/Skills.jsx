...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      className="flex items-center justify-center rounded-xl font-semibold bg-dark text-light py-3 px-6 shadow-dark absolute"
  ...
  return (
    <>
      ...
      <div className="w-full h-screen relative flex items-center justify-center rounded ">
        <motion.div
          className="flex items-center justify-center rounded-xl font-semibold bg-dark text-light p-6 shadow-dark"
          whileHover={{ scale: 1.1 }}
        >
          Web
        </motion.div>
