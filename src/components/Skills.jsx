...
const Skills = () => {
  return (
    <>
      <div className=" rounded-2xl items-center w-full h-full">
        <h2 className="font-bold text-8xl mt-64 w-full text-center pt-8">
          Skills
        </h2>
        <div className="w-full h-screen relative flex items-center justify-center rounded ">
          <motion.div
            className="flex items-center justify-center rounded-xl font-semibold bg-dark text-light p-4 shadow-dark dark:bg-light dark:text-dark"
            whileHover={{ scale: 1.1 }}
          >
            Fullstack
          </motion.div>
